...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Velda39',
      password: 'GxCU5FBM9sntgpo',
      email: 'Carolanne_Hammes@yahoo.com',
      name: 'Alberto Koelpin',
      userType: 470,
      mobileNo: '1-973-543-2341 x073',
      resetPasswordLink: {},
      loginRetryLimit: 424,
      loginReactiveTime: '2022-08-28T02:18:54.492Z',
      id: '623c5308f55d7412b98d0601'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Candida.Stracke88',
        'password':'zVVluUkouLqc3rp',
        'email':'Shannon.Skiles66@yahoo.com',
        'name':'Terence Waelchi',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'742.250.5867 x15519',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Shannon.Skiles66@yahoo.com', });
